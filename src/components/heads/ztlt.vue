            ...
            <tr>
              <td style="width: 75%; padding-right: 20px">
                ...
                <div class="report">
                  ...
                  <p style="color:rgb(91, 91, 91)"><b>内容摘要：</b>针对CAD/CAE一体化迭代优化设计要求，考虑统一的离散网格表示模式，底层数据采用CSG与网格体混合表示，几何内核采用底层几何与拓扑、上层语义特征框架三层结构表示，底层几何采用网格体和CSG混合表示，底层拓扑表示网格之间的连接关系，上层拓扑语义特征框架结构不仅用于用户的参数化设计，同时操纵几何求交计算过程中的remesh网格去冗余表示，对于几何操作过程，局部区域几何求交计算后都要进行上层语义特征驱动下的局部remesh计算，以保持网格模型的简洁性和计算高效性。
                  </p>
                </div>
              </td>
              <td style="width: 25%; vertical-align: top">

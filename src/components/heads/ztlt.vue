            ...
            <tr>
              <td style="width: 75%; padding-right: 20px">
                <p style="text-align: justify">
                  ...
                  <p style="color:rgb(91, 91, 91)"><b>报告摘要：</b>大型PDE特征值计算高效求解在数学上要用到的分析、代数及几何多方面的知识. 单纯用线性代数软件求解高维PDE特征值问题已出现瓶颈． 基于网格的几何不变性我们提出"引入几何网格将大型特征值问题因式分解为若干块子特征值问题预处理"，为下一步通过异步并行计算成倍提高计算效率提供算法基础。</p>
